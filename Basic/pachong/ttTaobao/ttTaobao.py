...
class OptTaobao:
    ...
    def login(self):
        ...
        self.dirver.find_element_by_name("TPL_username").send_keys(self.uname)
        self.dirver.find_element_by_name("TPL_password").send_keys(self.upwd)
        self.dirver.find_element_by_id("J_SubmitStatic").click()
        while True:
            time.sleep(1)
            try:
...
if __name__ == '__main__':
    uname = 'tb6103400_2012'
    upwd = 'w036181'

    obj = OptTaobao(uname, upwd)
    obj.login()
